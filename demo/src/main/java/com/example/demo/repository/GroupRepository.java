...
public interface GroupRepository extends JpaRepository<Group, Integer> {
    ...
    @Query(value = "update group_info set create_name = :email WHERE create_name = :username", nativeQuery = true)
    void updateCreateName(@Param ("email") String email, @Param("username") String username);
    //List<Group> edit_create_name_group_info(String email, String username);
